...
class ModuleServiceTest {
  ...
  @Mock private AssignmentModuleRepository assignmentModuleRepository;
  ...
  @Mock private Cache courseModulesCache;
  ...
  void create_archivedCourse_throwsCourseArchivedReadOnly() {
    ...
    CourseArchivedReadOnlyException thrown =
        assertThrows(
  ...
  void assignToModule_moduleFromDifferentCourse_throwsModuleNotInCourse() {
    ...
    AssignmentModule otherCourseModule =
    ...
    ModuleNotInCourseException thrown =
        assertThrows(
  ...
  void reorder_duplicateIds_throwsValidationError() {
    ...
    when(userRepository.findById(actorId)).thenReturn(Optional.of(actor));
    when(assignmentModuleRepository.findByCourseIdOrderByDisplayOrderAsc(courseId))
