...
import com.reviewflow.assignment.service.AssignmentGroupService;
...
class AssignmentGroupControllerIntegrationTest {
  ...
  @Mock private AssignmentGroupService assignmentGroupService;
  ...
  void create_validRequest_returnsCreatedResponse() {
    ...
    AssignmentGroupResponse response =
        AssignmentGroupResponse.builder()
            .id("GRP_HASH")
            .name("Projects")
    ...
    when(assignmentGroupService.create(
            eq(10L), eq(77L), eq("Projects"), eq(new BigDecimal("40.00")), eq(0), eq(1)))
        .thenReturn(response);
  ...
  void moveAssignment_groupFromAnotherCourse_propagatesException() {
    ...
    when(assignmentGroupService.moveAssignment(100L, 200L, 77L))
        .thenThrow(
            new GroupNotInCourseException("Assignment group does not belong to this course"));
  ...
  void moveAssignment_happyPath_returnsPayload() {
    ...
    AssignmentGroupMoveResponse moveResponse =
        AssignmentGroupMoveResponse.builder()
  ...
  void list_nonEnrolledUser_propagatesForbidden() {
    ...
    doThrow(new AccessDeniedException("Not authorized to view assignment groups for this course"))
        .when(assignmentGroupService)
        .verifyCanView(10L, 77L);
