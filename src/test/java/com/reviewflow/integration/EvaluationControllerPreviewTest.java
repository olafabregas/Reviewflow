...
import com.reviewflow.evaluation.controller.EvaluationController;
...
class EvaluationControllerPreviewTest {
  ...
  void previewPdf_withValidEvaluation_returns200WithPreviewDto() {
    ...
    ResponseEntity<ApiResponse<PreviewResponseDto>> response =
        controller.previewPdf("eval123", mockStudent);
  ...
  void previewPdf_instructorAccess_returns200() {
    ...
    // Act
    ResponseEntity<ApiResponse<PreviewResponseDto>> response =
        controller.previewPdf("eval456", mockInstructor);
  ...
  void previewPdf_returnsPdfContentType() {
    ...
    // Act
    ResponseEntity<ApiResponse<PreviewResponseDto>> response =
        controller.previewPdf("evalId", mockStudent);
