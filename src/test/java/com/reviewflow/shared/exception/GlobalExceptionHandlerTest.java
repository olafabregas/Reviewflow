...
import com.reviewflow.shared.exception.GlobalExceptionHandler;
...
class GlobalExceptionHandlerTest {
  ...
  void individualSubmissionOnly_mapsTo409WithCode() {
    ResponseEntity<ErrorResponse> response =
        handler.handleIndividualSubmissionOnly(
            new IndividualSubmissionOnlyException("only individual"));
  ...
  void cannotDeleteUncategorized_mapsTo409WithCode() {
    ResponseEntity<ErrorResponse> response =
        handler.handleCannotDeleteUncategorized(
            new CannotDeleteUncategorizedException("Cannot delete Uncategorized group"));
  ...
  void gradeOverviewUnavailable_mapsTo503WithCode() {
    ResponseEntity<ErrorResponse> response =
        handler.handleGradeOverviewUnavailable(
            new GradeOverviewUnavailableException("unavailable"));
  ...
  void storageException_mapsTo503WithCode() {
    ResponseEntity<ErrorResponse> response =
        handler.handleStorageException(
            new StorageException("s3 unavailable", new RuntimeException("x")));
