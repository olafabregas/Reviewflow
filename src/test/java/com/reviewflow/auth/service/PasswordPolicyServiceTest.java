...
import com.reviewflow.infrastructure.security.PasswordPolicyProperties;
  ...
  void validateForCreateOrUpdate_whenMissingUppercase_throwsValidationException() {
    ValidationException thrown =
        assertThrows(
            ...
            () ->
                passwordPolicyService.validateForCreateOrUpdate(
                    "strong@123", "user@reviewflow.com"));
  ...
  void validateForCreateOrUpdate_whenMatchesEmailLocalPart_throwsValidationException() {
    ValidationException thrown =
        assertThrows(
            ...
            () ->
                passwordPolicyService.validateForCreateOrUpdate(
                    "Strong123!", "Strong123!@reviewflow.com"));
    assertNotNull(thrown);
    assertEquals("VALIDATION_ERROR", thrown.getCode());
  }
