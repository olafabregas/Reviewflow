package com.reviewflow.announcement.controller;
...
import com.reviewflow.announcement.dto.request.CreateAnnouncementRequest;
...
public class AnnouncementController {
  ...
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        ...
        content =
            @Content(schema = @Schema(implementation = PaginatedAnnouncementResponse.class))),
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "401",
        description = "Unauthorized - authentication required",
        content = @Content(schema = @Schema(ref = "#/components/schemas/ApiErrorResponse"))),
