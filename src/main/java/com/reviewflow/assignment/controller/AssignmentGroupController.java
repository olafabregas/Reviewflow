...
public class AssignmentGroupController {
  ...
  @Operation(
      ...
      description = "Create a grade group for a course.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Return all grade groups for a course.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
        description = "Assignment groups retrieved successfully",
        content = @Content(schema = @Schema(implementation = AssignmentGroupListResponse.class)))
  })
  ...
  @Operation(
      summary = "Move assignment to group",
      description = "Move an assignment into a different grade group.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
