...
public class NotificationEventListener {
              ...
              user ->
                  eventPublisher.publishEvent(
                      new AnnouncementPostedEmailEvent(
                          ...
                          "" // courseCode - empty string for platform announcements, not available
                             // in event
                          )));
    }
  }
  ...
  /** PRD-09: Force logout event - notify target user their session was terminated */
  @Async("notificationExecutor")
  @EventListener
  ...
  /** PRD-09: Team unlock event - notify team members that team has been unlocked */
  @Async("notificationExecutor")
  @EventListener
  ...
  /**
   * PRD-09: Evaluation reopen event - notify instructor and team that evaluation has been reopened
   */
  @Async("notificationExecutor")
  @EventListener
