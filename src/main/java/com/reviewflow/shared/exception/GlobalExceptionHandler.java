...
import com.reviewflow.submission.exception.BlockedFileTypeException;
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleIndividualSubmissionOnly(
      IndividualSubmissionOnlyException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleTeamSubmissionRequired(
      TeamSubmissionRequiredException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleSubmissionTypeLocked(
      SubmissionTypeLockedException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleSubmissionNotRequired(
      SubmissionNotRequiredException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleCannotDeleteUncategorized(
      CannotDeleteUncategorizedException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  @ExceptionHandler(ModuleNotInCourseException.class)
  public ResponseEntity<ErrorResponse> handleModuleNotInCourse(ModuleNotInCourseException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  @ExceptionHandler(CourseArchivedReadOnlyException.class)
  public ResponseEntity<ErrorResponse> handleCourseArchivedReadOnly(
      CourseArchivedReadOnlyException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleGradeOverviewUnavailable(
      GradeOverviewUnavailableException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleInvalidFileStructure(
      InvalidFileStructureException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleExtensionCutoffPassed(
      ExtensionCutoffPassedException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleExtensionRequestExists(
      ExtensionRequestExistsException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleInvalidRequestedDate(
      InvalidRequestedDateException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleAssignmentNotInCourse(
      AssignmentNotInCourseException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
  ...
  public ResponseEntity<ErrorResponse> handleFileTooLargeForPreview(
      FileTooLargeForPreviewException ex) {
    ErrorResponse body =
        ErrorResponse.builder()
            .error(
                ErrorResponse.ErrorDetail.builder()
