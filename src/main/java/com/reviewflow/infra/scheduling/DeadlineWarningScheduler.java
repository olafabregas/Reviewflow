...
public class DeadlineWarningScheduler {
  ...
  private void checkDeadlines(int hoursUntilDue) {
    ...
    List<Long> assignmentIds = assignmentRepository.findPublishedDueBetween(windowStart, windowEnd);
    ...
    for (Long assignmentId : assignmentIds) {
      ...
      log.info(
          "Sent {}h deadline warning for assignment {} to {} students",
          hoursUntilDue,
          assignmentId,
          studentsWithoutSubmission.size());
    }
  }
}
