 ...
 *
 * <p>Provides HTML endpoints for viewing OpenAPI documentation: - /docs — Public API documentation
 * (Redoc) - /docs/admin — Admin API documentation - /docs/system — System administration API
 * documentation - /swagger-ui.html — Interactive Swagger UI (auto-provided by SpringDoc)
 */
@Controller
@RequestMapping("/docs")
...
public class DocsController {
  /**
   * GET /docs — Serves Redoc documentation for public API Displays only endpoints matching the
   * "public" group (excludes /admin/**, /system/**)
   */
  @Operation(
  ...
  /**
   * GET /docs/admin — Serves Redoc documentation for admin endpoints Displays only endpoints in
   * /admin/** group
   */
  @Operation(
  ...
  /**
   * GET /docs/system — Serves Redoc documentation for system admin endpoints Displays only
   * endpoints in /system/** group
   */
  @Operation(
      summary = "System admin API documentation",
      description =
          "Serves interactive Redoc documentation for system administration API endpoints"
              + " (SYSTEM_ADMIN only)")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
