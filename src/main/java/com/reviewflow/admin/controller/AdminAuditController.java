...
public class AdminAuditController {
  ...
  @Operation(
      ...
      description =
          "Get paginated audit logs with optional filters by actor, action, target type, and date"
              + " range. Used for compliance, troubleshooting, and security investigation."
              + " Admin-only endpoint.")
  @ApiResponses({
  ...
  public ResponseEntity<ApiResponse<Page<AuditLog>>> list(
    ...
    Page<AuditLog> page =
        auditService.findFiltered(actorId, action, targetType, dateFrom, dateTo, pageable);
