...
@Tag(
    name = "Courses",
    description =
        "Course management endpoints. Supports creating, updating, archiving courses, +"
...
public class CourseController {
  ...
  @Operation(
      ...
      description =
          "Retrieve paginated list of courses accessible to the authenticated user. Admins see all"
              + " courses, instructors see courses they teach, students see enrolled courses.")
  @ApiResponses({
  ...
  public ResponseEntity<ApiResponse<Page<CourseResponse>>> list(
    ...
    Page<Course> courses =
        courseService.listCoursesForUserPaged(user.getUserId(), user.getRole(), archived, pageable);
  ...
  @Operation(
      ...
      description =
          "Retrieve specific course details by ID. User must have access (admin, instructor, or"
              + " enrolled student).")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<ApiResponse<CourseResponse>> get(
    ...
    Course course =
        courseService.getCourseByIdWithAccessCheck(courseId, user.getUserId(), user.getRole());
  ...
  @Operation(
      ...
      description =
          "Update course details (code, name, term, description). Requires ADMIN role. Cannot"
  ...
  public ResponseEntity<ApiResponse<CourseResponse>> update(
      @PathVariable String id, @Valid @RequestBody UpdateCourseRequest request) {
    Long courseId = hashidService.decodeOrThrow(id);
    Course course =
  ...
  @Operation(
      ...
      description =
          "Archive (soft delete) a course. Archived courses remain in system but hidden from"
              + " listings. Requires ADMIN or SYSTEM_ADMIN role.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Assign an instructor (user with INSTRUCTOR role) to teach a course. Requires ADMIN role."
  ...
  @Operation(
      ...
      description =
          "Remove an instructor from a course. The instructor will no longer be able to access the"
              + " course. Requires ADMIN role.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Enroll a single student in a course. If student is already enrolled, operation succeeds"
              + " silently. Requires ADMIN or SYSTEM_ADMIN role.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Enroll multiple students (by email) in a course in a single operation. Returns"
              + " success/failure status for each email. Requires ADMIN role.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<ApiResponse<List<Map<String, String>>>> bulkEnroll(
      @PathVariable String id, @Valid @RequestBody BulkEnrollRequest request) {
    Long courseId = hashidService.decodeOrThrow(id);
  ...
  @Operation(
      ...
      description =
          "Remove a student from course enrollment. Student will no longer see course or"
  ...
  @Operation(
      ...
      description =
          "Retrieve list of all students enrolled in the course with enrollment details. Requires"
  ...
  public ResponseEntity<ApiResponse<List<StudentResponse>>> getStudents(
    ...
    List<com.reviewflow.model.entity.CourseEnrollment> enrollments =
        courseService.getEnrollmentsForCourse(courseId);
  ...
  private CourseResponse toResponse(Course c) {
    return CourseResponse.builder()
        ...
        .createdById(
            hashidService.encode(c.getCreatedBy() != null ? c.getCreatedBy().getId() : null))
