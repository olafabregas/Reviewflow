...
@Tag(
    name = "Evaluations",
    description =
        "Assignment submission grading and evaluation. Supports creating evaluations, scoring using"
            + " rubrics, publishing grades, and generating evaluation PDFs. Instructor-only"
            + " access.")
public class EvaluationController {
  ...
  @Operation(
      ...
      description =
          "Create new evaluation for a submission. Instructor-only. Initializes as draft with empty"
              + " scores. Returns HTTP 201 with evaluation details.")
  @ApiResponses({
  ...
  @Operation(
      ...
      description =
          "Retrieve full evaluation details including all rubric scores, comments, and publication"
              + " status. Students can only view published evaluations for their submissions.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<ApiResponse<EvaluationResponse>> get(
    ...
    Evaluation ev =
        evaluationService.getEvaluationWithAccessControl(evalId, user.getUserId(), user.getRole());
  ...
  @Operation(
      ...
      description =
          "Update all rubric criterion scores for an evaluation at once. Required: scores map"
              + " (criterionId â†’ score). Instructor-only. Cannot update published evaluations.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Update score and comment for a single rubric criterion. Instructor-only. "
  ...
  public ResponseEntity<ApiResponse<EvaluationResponse>> patchScore(
    ...
    Evaluation ev =
        evaluationService.patchScore(
            evalId, criterionIdLong, request.getScore(), request.getComment(), user.getUserId());
    return ResponseEntity.ok(ApiResponse.ok(toResponse(ev)));
  }
  ...
  @Operation(
      ...
      description =
          "Update the overall evaluation comment visible to students. Instructor-only. "
  ...
  public ResponseEntity<ApiResponse<EvaluationResponse>> setComment(
    ...
    Long evalId = hashidService.decodeOrThrow(id);
    Evaluation ev =
        evaluationService.setComment(evalId, request.getOverallComment(), user.getUserId());
    return ResponseEntity.ok(ApiResponse.ok(toResponse(ev)));
  }
  ...
  @Operation(
      ...
      description =
          "Publish evaluation making it visible to students. Transition from draft to published. "
  ...
  @Operation(
      ...
      description =
          "Reopen a published evaluation for editing. Transition from published to draft. "
  ...
  @Operation(
      ...
      description =
          "Asynchronously generate PDF of evaluation for formal grading records. "
  ...
  @Operation(
      ...
      description =
          "Download the generated evaluation PDF as binary attachment. "
  ...
  public ResponseEntity<Resource> downloadPdf(
    ...
    return ResponseEntity.ok()
        .header(
            ...
            "attachment; filename=\"evaluation_" + evalId + ".pdf\"")
  ...
  @Operation(
      ...
      description =
          "Get a preview URL for evaluation PDF from S3 storage. Returns pre-signed S3 URL. "
  ...
  public ResponseEntity<ApiResponse<PreviewResponseDto>> previewPdf(
    ...
    PreviewResponseDto previewDto =
        evaluationService.getPdfPreviewUrl(id, user.getUserId(), user.getRole());
  ...
  static EvaluationResponse getEvaluationResponse(
      Evaluation ev,
