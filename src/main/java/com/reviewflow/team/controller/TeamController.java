...
import com.reviewflow.team.dto.response.TeamMemberCreatedResponse;
...
@Tag(
    name = "Teams",
    description =
        "Team collaboration management for group assignments. Supports team creation, member"
            + " management, invitations, and team-based submission tracking.")
public class TeamController {
  ...
  @Operation(
      ...
      description =
          "Retrieve all teams for an assignment. Instructors and admins see all teams; "
  ...
  public ResponseEntity<ApiResponse<List<TeamResponse>>> list(
      @PathVariable String assignmentId, @AuthenticationPrincipal ReviewFlowUserDetails user) {
    Long assignmentIdLong = hashidService.decodeOrThrow(assignmentId);
    List<Team> teams =
        teamService.listTeamsForAssignment(assignmentIdLong, user.getUserId(), user.getRole());
  ...
  @Operation(
      summary = "Create team",
      description =
          "Create new team for assignment. Required: team name. Team creator becomes first member. "
  ...
  @Operation(
      ...
      description =
          "Automatically create and assign teams for all enrolled students. Optional: maxTeamSize"
              + " (default 3). Requires INSTRUCTOR role. Distributes students evenly across teams.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<ApiResponse<List<TeamResponse>>> autoAssign(
    ...
    return ResponseEntity.ok(
        ApiResponse.ok(created.stream().map(this::toResponse).collect(Collectors.toList())));
  }

  @Operation(
      summary = "Get team details",
      description =
          "Retrieve team information including member list and join status. "
  ...
  @Operation(
      summary = "Rename team",
      description =
          "Change team name. Only team creator or instructors can rename. Required: new name.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Send team invitation to user by email. User receives notification and can"
              + " accept/decline. Required: inviteeEmail. Only team members can invite.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<ApiResponse<TeamMemberCreatedResponse>> invite(
    ...
    Long teamId = hashidService.decodeOrThrow(id);
    TeamMember member =
        teamService.inviteMember(teamId, request.getInviteeEmail(), user.getUserId());
    return ResponseEntity.ok(
        ApiResponse.ok(
            TeamMemberCreatedResponse.builder()
  ...
  @Operation(
      ...
      description =
          "Accept or decline team membership invitation. Required: accept (true/false). "
  ...
  public ResponseEntity<ApiResponse<Map<String, String>>> respond(
    ...
    TeamMember member =
        teamService.respondToInvite(teamMemberId, request.getAccept(), user.getUserId());
  ...
  @Operation(
      ...
      description =
          "Remove a member from a team. Team members can only remove themselves; "
  ...
  @Operation(
      summary = "Lock team",
      description =
          "Lock team from further membership changes. Locked teams prevent new invitations and"
              + " membership modifications. Requires INSTRUCTOR role.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Retrieve all submissions for a team including version history. Team members can view"
              + " their own submissions; instructors can view any team's submissions.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<ApiResponse<List<SubmissionResponse>>> getTeamSubmissions(
    ...
    List<Submission> submissions =
        submissionService.getTeamSubmissions(teamId, user.getUserId(), user.getRole());
  ...
  private TeamResponse toResponse(Team t) {
    List<TeamResponse.TeamMemberResponse> members =
        t.getMembers() != null
            ? t.getMembers().stream()
                .map(
                    m ->
                        TeamResponse.TeamMemberResponse.builder()
                            ...
                            .invitedById(
                                hashidService.encode(
                                    m.getInvitedBy() != null ? m.getInvitedBy().getId() : null))
    ...
    return TeamResponse.builder()
        ...
        .assignmentId(
            hashidService.encode(t.getAssignment() != null ? t.getAssignment().getId() : null))
        .assignmentTitle(t.getAssignment() != null ? t.getAssignment().getTitle() : null)
        .name(t.getName())
        .isLocked(t.getIsLocked())
        .createdById(
            hashidService.encode(t.getCreatedBy() != null ? t.getCreatedBy().getId() : null))
